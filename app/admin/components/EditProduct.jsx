...
const normalizeForCompare = (f) => ({
  ...
  featured: !!f.featured,
  allowReviews: f.allowReviews !== false,
});
...
const getInitialData = (product) => ({
  ...
  allowReviews: product?.allowReviews !== false,
});
  ...
  const fetchCategories = useCallback(async () => {
    try {
      ...
      if (
        ...
        const merged = [
          ...dynamic,
          ...FALLBACK_CATEGORIES.filter((x) => !dynamic.includes(x)),
        ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField("sale_start_date", e.target.value)
                  }
                />
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                {formData.features.map((v, i) => (
                  <div key={i} className="flex items-center gap-2 mt-2">
                    <input
                      ...
                      value={v}
                      onChange={(e) =>
                        updateArrayItem("features", i, e.target.value)
                      }
                    />
                    <button
                      type="button"
                ...
                <button
                  ...
                  className="mt-2 text-sm text-blue-600 inline-flex items-center gap-1"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateField("size_chart", e.target.value)}
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField("care_instructions", e.target.value)
                    }
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateField("shipping_class", e.target.value)
                  }
                >
          ...
          <div className="bg-white rounded-lg border p-5">
            ...
            <div className="space-y-4">
              <input
                ...
                onChange={(e) =>
                  updateNestedField("dimensions", "length", e.target.value)
                }
              />
              <input
                type="number"
                ...
                onChange={(e) =>
                  updateNestedField("dimensions", "width", e.target.value)
                }
              />
              <input
                type="number"
                ...
                onChange={(e) =>
                  updateNestedField("dimensions", "height", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border p-5">
              ...
              {formData.colors.map((v, i) => (
                <div key={i} className="flex items-center gap-2 mt-2">
                  <input
                    ...
                    value={v}
                    onChange={(e) =>
                      updateArrayItem("colors", i, e.target.value)
                    }
                  />
                  <button
                    type="button"
              ...
              {formData.sizes.map((v, i) => (
                <div key={i} className="flex items-center gap-2 mt-2">
                  <input
                    ...
                    value={v}
                    onChange={(e) =>
                      updateArrayItem("sizes", i, e.target.value)
                    }
                  />
                  <button
                    type="button"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField("related_products", e.target.value)
                }
              />
            </div>
          </div>
