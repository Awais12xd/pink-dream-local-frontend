...
const AdminLogin = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="theme-admin-scope min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Decorative Elements */}
